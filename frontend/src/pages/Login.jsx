      ...
      <div className="w-full max-w-md z-10">
        <div className="glass-panel p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight">AcaIntel</h1>
            <p className="text-slate-400 mt-2 text-center">Intelligent Partnership Automation</p>
          </div>
          ...
          <button 
            onClick={() => alert("Google Sign-In is not fully configured for this environment. Please log in using your email.")}
            type="button" 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm mt-2">
              <label className="flex items-center space-x-2 cursor-pointer">
                <input type="checkbox" className="checkbox checkbox-primary checkbox-sm rounded-md border-slate-600 bg-slate-900" />
